> **Legacy Python version.** The current native Swift app is at the [repository root](../..). These instructions apply only to this directory; after cloning, run `cd WhisperBatch/legacy/python`.
