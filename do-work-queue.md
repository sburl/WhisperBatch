...
Stage 1 task 2 (CLI summary output) is covered by [PR-N](plan-and-pr-tracking.md#pr-tracking-table-for-work-to-execute).
Stage 1 task 4 (output format flags) is covered by [PR-O](plan-and-pr-tracking.md#pr-tracking-table-for-work-to-execute).
...
Stage 1 task 1 (deterministic file ordering in process_directory) is now covered by [PR-DF](plan-and-pr-tracking.md#pr-tracking-table-for-work-to-execute), which adds deterministic ordering, directory validation, and batch summary behavior.
