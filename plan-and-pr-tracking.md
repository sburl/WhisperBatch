...
| 102 | PR-DR | Reuse core timestamp-only format constant in GUI output rendering | `transcribe_gui.py` | Done | Gemini requested | Removes local constant duplication for timestamp-only formats by sourcing from shared core constant. |
